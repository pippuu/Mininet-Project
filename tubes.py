...
net.addLink(hB,r3,intfName1 = 'hB-eth0',intfName2 = 'r3-eth0',cls = TCLink, bw = 1)
net.addLink(hB,r4,intfName1 = 'hB-eth1',intfName2 = 'r4-eth1',cls = TCLink, bw = 1)
...
hB.cmd("ip rule add from 190.100.0.10 table 1")
hB.cmd("ip rule add from 190.100.0.13 table 2")
hB.cmd("ip route add 190.100.0.8/30 dev hB-eth0 scope link table 1")
hB.cmd("ip route add default via 190.100.0.9 dev hB-eth0 table 1")
hB.cmd("ip route add 190.100.0.12/30 dev hB-eth1 scope link table 2")
hB.cmd("ip route add default via 190.100.0.14 dev hB-eth1 table 2")
